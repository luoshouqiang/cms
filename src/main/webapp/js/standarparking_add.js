...
$("#standerparking-add-form").validate({
       submitHandler: function(form) {
		...
		var searchData={areaId:areaId,parkingLotsId:lotsId,parkingFloor:parkingFloor,parkingMax:$("#parking-number").val(),prefix:$("#parking-prefix").val(),
		index:$("#start-number").val()};
			 $.ajax({
             type: "post",
             url: "/cms/area/addStandardParking",
			 data: searchData,
             dataType: "json",
	...
	$(document).on("click",".page .pageone",function(){
			...
			console.log(rePageIndex);
			 ...
			 getParking(areaId,lotsId,parkingFloor,"standard",areaName,rePageIndex,pageSize);
			 }
	});
